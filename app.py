...
with tab1:
    ...
    if "student_id" in learner_df.columns and "student_id" in reg_df.columns:
        ...
        absent_count = len(reg_ids - learner_ids)
    else:
        absent_count = 0
    ...
    k3.markdown(f"<div class='kpi-box'><div class='kpi-title'>Absent Learners</div><div class='kpi-value'>{absent_count}</div></div>", unsafe_allow_html=True)
